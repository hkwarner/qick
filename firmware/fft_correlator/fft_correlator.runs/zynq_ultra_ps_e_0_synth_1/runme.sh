...
HD_PWD='C:/Users/hanak/Documents/GitHub/qick/firmware/fft_correlator/fft_correlator.runs/zynq_ultra_ps_e_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_ultra_ps_e_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_ultra_ps_e_0.tcl
