...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins fft_0/S00_AXI_fft_0]
	connect_bd_net [get_bd_pins fft_0/s00_axi_fft_0_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins fft_0/s00_axi_fft_0_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_fft_0_S00_AXI_fft_0_* ]]
	puts $fp "set s00_axi_fft_0_addr ${offset}"
